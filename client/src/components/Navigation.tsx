...
import { Home, LightbulbIcon, Wand2, Menu } from "lucide-react";
...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-sm border-t md:hidden">
